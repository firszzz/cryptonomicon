    ...
    <div class="container">
      ...
      <template v-if="tickers.length">
        ...
        <div>
          ...
          >
          Вперёд</button>
          <div class="flex-row mx-2"><span>Фильтр: </span><input v-model="filter"></div>
...
export default {
  ...
  methods: {
    helpTickersMenu() {
      ...
      this.tickersMenu.push(find(this.tickersList.filter(t => t.toLowerCase().startsWith(value))));
      console.log(this.tickersMenu);
    },
